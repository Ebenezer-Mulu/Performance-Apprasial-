...
const validationSchema = Yup.object().shape({
  ...
  pemail: Yup.string().email("Invalid email format").required("Personal email is required"),
  cemail: Yup.string().email("Invalid email format").required("Company email is required"),
